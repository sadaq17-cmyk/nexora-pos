...
export const API_PERMISSION_MAP = {
  ...
  "receivables.getDashboard": ["customers", "view", "result"],
  "receivables.getAging": ["customers", "view", "result"],
  "receivables.listInvoices": ["customers", "view", "result"],
  "receivables.getOutstanding": ["customers", "view", "result"],
  "receivables.getAccount": ["customers", "view", "result"],
  "receivables.checkCreditLimit": ["customers", "view", "result"],
  "receivables.getStatement": ["customers", "view", "result"],
  "receivables.getInvoice": ["customers", "view", "result"],
  "receivables.getPolicy": ["customers", "view", "result"],
  "receivables.createInvoice": ["customers", "create", "result"],
  "receivables.receivePayment": ["customers", "edit", "result"],
  "receivables.createCreditNote": ["customers", "edit", "result"],
  "receivables.updatePolicy": ["customers", "edit", "result"],
  ...
  "suppliers.getAging": ["suppliers", "view", "result"],
  "suppliers.getPayables": ["suppliers", "view", "result"],
  "suppliers.getInsights": ["suppliers", "view", "result"],
  "suppliers.getEnterpriseDashboard": ["suppliers", "view", "result"],
  "suppliers.addStatementEntry": ["suppliers", "edit", "result"],
  "suppliers.deleteStatementEntry": ["suppliers", "edit", "result"],

  "purchaseRequests.list": ["purchases", "view", "result"],
  "purchaseRequests.get": ["purchases", "view", "result"],
  "purchaseRequests.create": ["purchases", "create", "result"],
  "purchaseRequests.convert": ["purchases", "create", "result"],
  "purchaseRequests.updateStatus": ["purchases", "edit", "result"],
